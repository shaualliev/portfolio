...
Please install and activate it before starting to use the theme Etude.
...
Theme documentation is available on https://doc.themerex.net/etude/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Etude is Fontello.
