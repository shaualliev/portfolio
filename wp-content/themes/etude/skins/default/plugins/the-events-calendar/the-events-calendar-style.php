...
if ( ! function_exists( 'etude_tribe_events_get_css' ) ) {
	add_filter( 'etude_filter_get_css', 'etude_tribe_events_get_css', 10, 2 );
	function etude_tribe_events_get_css( $css, $args ) {
