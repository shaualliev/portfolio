...
if ( ! function_exists( 'etude_woocommerce_get_css' ) ) {
	add_filter( 'etude_filter_get_css', 'etude_woocommerce_get_css', 10, 2 );
	function etude_woocommerce_get_css( $css, $args ) {
...
$fdir = etude_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
